...
def FDollar0(DollarValue):
    # Function will accept a value and format it to $#,### (no decimal)
...
def FNumber0(Value):
    # Function will accept a value and format it to #### (no comma or decimal)
...
def FNumber1(Value):
    # Function will accept a value and format it to ####.# (no comma, 1 decimal)
...
def FNumber2(Value):
    # Function will accept a value and format it to ####.## (no comma, 2 decimals)
